...
mysql -uisucon torb -e 'ALTER TABLE reservations ADD INDEX (user_id)'
mysql -uisucon torb -e 'ALTER TABLE reservations ADD INDEX (canceled_at, event_id, sheet_id)'
mysql -uisucon torb -e 'ALTER TABLE reservations ADD INDEX (canceled_at, event_id)'
